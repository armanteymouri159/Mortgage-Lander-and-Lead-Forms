  ...
  const lenders = [
    {
      ...
      tag: '🏆 #1 Mortgage Lender in the U.S.',
      rate: '7.49',
    ...
    },
    {
      ...
      badge: '#2d6a4f',
      name: 'NFTYDoor',
      tag: '🚀 Instant digital HELOC decisions',
      rate: '6.99',
      type: 'HELOC',
      details: 'Fully digital close · No SSN to check rate · Funds in days · No hidden fees'
    },
    {
      initials: 'SE',
      color: '#7B2D8B',
      badge: '#9b3dab',
      name: 'Spring EQ',
      tag: '🏠 Home equity specialists',
      rate: '7.25',
      type: state.loanProduct === 'heloc' ? 'HELOC' : 'Home Equity Loan',
      details: 'Up to 95% CLTV · Borrow up to $500K · Fast approvals · Flexible terms'
    }
  ];
